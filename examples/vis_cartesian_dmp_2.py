...
#n_steps = 1248
df = pd.read_csv('../FYP-DMPs-for-Complex-Tasks/draw_2_pose.csv')
df_np = np.array(df)
...
fig.plot_transform(ee2base_start, s=0.15, name = 'start')
fig.plot_transform(ee2base_end, s=0.15, name = 'end')
fig.plot_transform(trajectory[-1], s=0.15, name = 'traj1')
fig.plot_transform(trajectory[-1], s=0.15, name = 'traj2')
